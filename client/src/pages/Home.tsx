    ...
    <Layout>
      ...
      <div className="container relative z-20 -mt-16">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { label: t('home.stats.daily_auctions'), value: "10M+", icon: Gavel, color: "text-blue-600" },
            { label: t('home.stats.latency'), value: "<45ms", icon: Zap, color: "text-amber-500" },
            { label: t('home.stats.active_bidders'), value: "12", icon: Cpu, color: "text-emerald-500" },
            { label: t('home.stats.strategies'), value: "4", icon: Layers, color: "text-purple-500" },
          ].map((stat, i) => (
          ...
          {[
            {
              ...
              desc: t('home.features.explainable.desc'),
              icon: ShieldCheck,
              bg: "bg-blue-50",
